...
## 1) 투명도가 큰 원 만들기
<img src="https://github.com/yudonlee/TIL/blob/main/iOS/2022/February/pictures/04_01_transparentCircle.png" width="400" height="400">
```swift
 ZStack {
                Circle()
...
```
위 코드를 통해서, 투명도 있는 원을 만들게 된다. 

## 2) 투명도가 없는 원을 만들어 진행상황 표시하기.
<img src="https://github.com/yudonlee/TIL/blob/main/iOS/2022/February/pictures/04_01_progressCircle.png" width="400" height="400">
```swift
ZStack {
            Circle()
                .stroke(lineWidth: 20.0)
...
위 코드를 통해서, 투명도가 없는 진한 원과 투명도가 있는 원이 overlap된다. 이때 trim함수의 용도는 원에서 원하는 부분만큼 자르는 것으로서, 3시부터 시계방향에서 시작되어 parameter to값을 기준으로 자르게 된다.(0.0 <= from, to <= 1.0)
...
<img src="https://github.com/yudonlee/TIL/blob/main/iOS/2022/February/pictures/04_01_progressBarRecording.gif" width="400" height="400">
...
## 가장 기본적인 사용법
<img src="https://github.com/yudonlee/TIL/blob/main/iOS/2022/February/pictures/04_01_List.png" width="400" height="400">
