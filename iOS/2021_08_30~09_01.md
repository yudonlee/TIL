...
<img src="https://github.com/yudonlee/TIL/blob/main/iOS/pictures/UICollectionViewLayoutResult.png" width="300" height="300">
...
## 4. UICollectionViewDelegate, Datasource compatible 한가?

프로젝트를 만들떄 주의해야 할 점: 프레임워크의 이름과 동일하게 만들어선 안된다.

cameraRoll:

tableView의 Datasource와 Delegate 연결해준다

마지막으로 사용자 프라이버시 접근관계상 프라이버시 문구를 작성해준다.
add row-> privacy photo libary
